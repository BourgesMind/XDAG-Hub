...
import { PendingTransaction } from "_src/ui/app/pages/home/transaction-history-list/PendingTransaction";
...
function TransactionHistoryList() {
	...
	return (
		<div className="flex flex-col flex-nowrap h-full overflow-x-visible">
			<PageTitle title={ t( "TransactionHistoryList.YourTransactions" ) }/>
